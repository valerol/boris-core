# BOIS:SIMA&BORIS — memory file with BORIS EGO v1.2
...
- Public release: v1.4.5 — EGO Default Localized Term Understanding.
- BOIS/BORIS main: v2.18.
- SIMA: v0.4.
- BORIS EGO: v1.2 — Ethical Goal Orchestrator [этический оркестратор производных целей].
...
v1.4.5 → v1.4.4 Default Maximal Format Stable → v1.4.3 Default Core → v1.4.2 Ethical Goal Orchestrator → v1.4.1 Release Candidate Repair → v1.4.0 Immune Ready.
