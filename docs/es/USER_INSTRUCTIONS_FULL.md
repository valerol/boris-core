# Instrucciones completas de usuario

Este archivo es una entrada explícita para instrucciones completas de usuario. El texto operativo siguiente coincide con `USER_MANUAL_FULL.md`.
