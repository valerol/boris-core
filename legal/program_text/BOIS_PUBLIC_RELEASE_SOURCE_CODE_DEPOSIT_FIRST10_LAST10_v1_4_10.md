# BOIS source code deposit selection [депозитная выборка исходного кода] v1.4.10

```text
BOIS:SIMA&BORIS Public Release v1.4.10 - Program Text Deposit Selection [депозитная выборка текста программы]
Generated [создано]: 2026-06-12
Source listing pages by package page model [страницы исходного листинга по модели пакета]: 52 pages, 54 lines/page.
Selection [выборка]: first 10 and last 10 pages [первые 10 и последние 10 страниц].
Attorney / claimant selects final deposit copy [адвокат / заявитель выбирает финальную депозитную копию].
Not legal advice [не юридическая консультация].

===== SOURCE LISTING PAGE 1 OF 52 =====
